...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const css = [
      ...
      '[role="dialog"]:has([data-slot="settings.section"]) ul:not(li > ul) > li button{background:transparent!important;-webkit-backdrop-filter:none!important;backdrop-filter:none!important;box-shadow:none!important}',
      ...
      '[role="dialog"]:has([data-slot="settings.section"]) ul:not(li > ul) > li{background:transparent!important}',
