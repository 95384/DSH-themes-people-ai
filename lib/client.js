...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const css = [
      ...
      // seat — :has() keeps other dialogs untouched.
      '[role="dialog"]:has([data-slot="settings.section"]){background:rgba(15,17,21,0.35)!important;-webkit-backdrop-filter:blur(1px);backdrop-filter:blur(1px)}',
    ].join('\n');
